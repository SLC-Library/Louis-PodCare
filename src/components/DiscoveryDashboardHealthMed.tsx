              ...
              >
                ...
                <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-6 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <button
                    ...
                    className={`h-14 sm:h-16 px-8 ${isAudioOnlyPodcast(featuredEpisode) ? 'bg-emerald-600 hover:bg-emerald-700 ring-emerald-500/30' : 'bg-red-600 hover:bg-red-700 ring-red-500/30'} text-white rounded-full flex items-center gap-3 shadow-2xl hover:scale-105 active:scale-95 transition-all duration-200 ring-4 font-bold text-base`}
                  >
                    <span
                      className="material-symbols-outlined"
                ...
                <div className={`absolute top-4 left-4 ${isAudioOnlyPodcast(featuredEpisode) ? 'bg-emerald-600/90 border-emerald-300/40' : 'bg-red-600/90 border-red-300/40'} backdrop-blur-md px-3.5 py-1.5 rounded-full text-[12px] font-bold text-white flex items-center gap-1.5 border shadow-md z-10`}>
